...
TECHNO_IMG = "https://telegra.ph/file/23987cba299981eafb33c.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/Anshu_Priy")],
                                                                                   [InlineKeyboardButton(text="ADD Jack Sparrow TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/Anshu2006/GRANDROBOT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("Captain Jack Sparrow is still alive.")
